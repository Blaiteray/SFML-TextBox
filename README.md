...
|**void**| `setSize(float width, float height)` | Set textbox size. |
|**void**| `setPosition(float positionX, float positionY)` | Set position of upper-left corner of the textbox. |
|**void**| `setBorder(float thickness)` | Set border thickness. |
